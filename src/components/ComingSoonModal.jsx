...
const txtFR = {
  ...
  sub: "L'application Kreyolang est disponible sur iOS et Android.\nEmbarque dès maintenant !",
  appstore: "Télécharger sur l'",
  gplay: 'Disponible sur',
};
const txtEN = {
  title: 'Available now!',
  sub: "The Kreyolang app is available on iOS and Android.\nStart your journey now!",
    ...
    >
      ...
      >
        ...
        <div className="w-20 h-20 mx-auto mb-5">
          <img src="/mascot.webp" alt="Kreyolang" className="w-full h-full object-contain" />
        </div>
        ...
        <div className="space-y-3">
          <a
            ...
            className="w-full flex items-center gap-4 bg-slate-900 hover:bg-slate-700 text-white py-4 px-5 rounded-2xl border-b-4 border-slate-700 transition-colors"
          >
