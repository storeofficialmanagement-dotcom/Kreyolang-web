...
const LangCard = ({ l }) => (
  <div className={`rounded-2xl border-2 p-4 ${l.color} hover:-translate-y-1 transition-all duration-300`}>
    ...
    <section id="langues" className="py-20 bg-slate-50">
      <div ref={ref} className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-2">
          {creoles.map((l, i) => <LangCard key={i} l={l} />)}
        </div>
        <p className="text-xs text-violet-500 font-bold mb-10 flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-2">
          {african.map((l, i) => <LangCard key={i} l={l} />)}
        </div>
